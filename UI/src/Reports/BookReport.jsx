...
const BookReport = () => {
  ...
  const totalPrice =  data.reduce((totalPrice, book) => totalPrice + book.price , 0)
  const totalQuantity = data.reduce((totalQuantity, book) => totalQuantity + book.quantity , 0)
  ...
  return (
    <div>
      ...
      />
        ...
        <strong>Total Quantity: {totalQuantity} books</strong>
    </div>
  );
};
