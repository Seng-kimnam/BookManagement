    ...
    },
    {
      ...
      render: (_, record) => (
        <div className="flex justify-evenly text-white items-center">
          <EditOutlined className="p-4 bg-blue-600 rounded-md" onClick={() => handleEdit(record)}/>
          <DeleteOutlined className="p-4 bg-red-600  rounded-md" onClick={() => handleDelete(record.publisherID , record.name)} />
