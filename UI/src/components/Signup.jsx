  ...
  return (
    <article className="h-screen flex  justify-center items-center login-bg">
      <form
        action="/AdminList"
        method="post"
        className="max-w-full mx-auto  full-border bg-blur p-10 login-container"
        onSubmit={handSignUp}
      >
        <div className="mb-4 bg-b">
          <h3 className="text-4xl font-bold p-5 dark:text-white  text-white rounded-full text-center mb-4">
            Welcome to Sign up!
          </h3>
          ...
          <input 
          className="w-32 mb-2 rounded-lg bg-gray-100"
            ref={idNumber}
            type="text"
            id="name"
        ...
        <div className="mb-4">
          ...
          <div className="flex ">
            ...
            />
            <div
              className="p-2 font-bold text-2xl absolute right-14 cursor-pointer"
        ...
        <div className="flex items-start mb-4">
          <div className="flex items-center">
            ...
            <label
              htmlFor="remember"
              className="ms-2 text-lg font-medium text-white dark:text-gray-300 cursor-pointer"
            >
              Remember me
            </label>
            <div className="ml-40 text-white">
              ...
              <button
                onClick={() => navigate("/")}
                className="ms   hover:text-amber-200 text-yellow-300 font-bold  transition-all duration-150 "
              >
                Login
              </button>
            </div>
